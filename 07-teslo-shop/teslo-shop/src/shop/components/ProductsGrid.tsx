...
export const ProductsGrid = ({ products }: Props) => {
    ...
    const handleViewModeChange = (mode: 'grid' | 'list') => {
        searchParams.set('viewMode', mode);     // ambia el valor dentro del objeto. "URLSearchParams"
        setSearchParams(searchParams);          // Actualizá la URL con este objeto que acabo de modificar
    }
